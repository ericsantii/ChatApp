...
class MessageDAO:
    def __init__(self):
        ...
        M1 = [3,'Hola bebe como tu estas?', '1970-01-01 00:00:01', 'NULL',1, 111]
        M2 = [12,'Entra al cuarto y subele el volumen al radio', '2001-12-04 03:02:22', 'https://ibb.co/cN3MkS',5, 112]
